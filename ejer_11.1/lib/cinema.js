...
export const ACTORS = [
  ...
  },
  {
    ...
    bio: "Actor y productor estadounidense. Uno de los actores más taquilleros de todos los tiempos."
  },
  {
    id: "nm0000237",
    name: "John Travolta",
    ...
    bio: "Actor, cantante y bailarín estadounidense."
  },
  {
    id: "nm0000235",
    name: "Uma Thurman",
    ...
    bio: "Actriz y modelo estadounidense, musa de Quentin Tarantino."
  },
  {
    id: "nm0000138",
    ...
    bio: "Actor y productor estadounidense, ganador de un Oscar."
  },
  {
    id: "nm0000158",
    name: "Tom Hanks",
    ...
    bio: "Actor y productor estadounidense, dos veces ganador del Oscar."
  },
  {
    id: "nm0000194",
    ...
    bio: "Actriz israelí-estadounidense, ganadora de un Oscar."
  }
];
...
export function getFilmographyByActorId(actorId) {
  ...
  return roles.map(role => MOVIES.find(movie => movie.id === role.movieId));
}
